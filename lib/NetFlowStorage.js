...
function NetFlowStorage(elasticsearch, logger, config) {
    this.host = config.get('NetFlowStorage.elasticsearch_host');
    this.shards = config.get('NetFlowStorage.elasticsearch_shards');
    this.replicas = config.get('NetFlowStorage.elasticsearch_replicas');
